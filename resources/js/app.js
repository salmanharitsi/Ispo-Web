...
document.addEventListener('DOMContentLoaded', function () {
    ...
    expandBtnFixed.className = 'expand-btn-fixed w-6 h-6 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300';
