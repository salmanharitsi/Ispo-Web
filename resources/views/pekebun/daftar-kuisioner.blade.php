...
@section('title', 'Pekebun Daftar Kuisioner Kebun')
    ...
    <div class="mb-6">
      <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
        <div class="mb-4 md:mb-0">
          ...
          <p class="text-gray-600 mt-1">Segera lengkapi kuisioner kebun kelapa sawit milik Anda</p>
        </div>
      </div>
            ...
            <div class="flex items-start">
              ...
              <div>
                ...
                <p class="text-sm text-yellow-700 mt-1">
                  Terdapat <span class="font-semibold">{{ $needKuisioner }}</span> kebun yang belum dilengkapi kuisioner, lengkapi segera!
                </p>
              </div>
            </div>
          </div>
