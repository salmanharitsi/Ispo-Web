              ...
              <div class="mt-4 bg-amber-50 border border-amber-200 rounded-lg p-4">
                <div class="flex items-start">
                  ...
                  <div class="flex-1">
                    ...
                    <p class="text-amber-700 text-sm mb-3">Finalisasi minimal 1 kebun yang sudah lengkap datanya (data kebun, pemetaan, dan kuisioner) agar dapat dinilai oleh admin untuk penilaian kesiapan.</p>
                    <a href="{{ route('pekebun.daftar-kebun') }}" class="inline-flex items-center bg-amber-600 text-white px-4 py-2 rounded-lg hover:bg-amber-700 transition text-sm font-semibold">
                      <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
