      ...
      <div class="bg-green-50 border border-green-500 p-4 rounded-xl">
        <div class="flex items-start">
          ...
          <div>
            ...
            <p class="text-sm text-green-700 mt-1">Tambahkan minimal 1 kebun untuk melanjutkan proses sertifikasi ISPO. Pastikan data yang diisi akurat dan sesuai kondisi lapangan.</p>
          </div>
        </div>
      </div>
    </div>
