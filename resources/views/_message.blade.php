...
@if (!empty(session('success')))
    <div id="toast-success"
        class="toast-hidden z-1000 fixed top-5 left-1/2 transform -translate-x-1/2 
               ...
               bg-linear-to-r from-green-500 via-green-600 to-green-700 
        ...
        <div class="relative">
            ...
            <div
                class="inline-flex items-center justify-center shrink-0 w-10 h-10 
    ...
    <div id="toast-danger"
        ...
        <div class="relative">
            ...
            <div
                ...
                <svg class="w-6 h-6 relative z-10" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
...
@if (!empty(session('warning')))
    <div id="toast-warning"
        class="toast-hidden z-1000 fixed top-5 left-1/2 transform -translate-x-1/2 
               flex items-center w-full max-w-md p-4 text-white 
               bg-linear-to-r from-amber-500 via-amber-600 to-orange-600 
